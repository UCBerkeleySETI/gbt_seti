...
%--------------------------------------------------------------------------
% chi2_astrometric_binary function                                      EB
...
%          Freq  = 1./(330:1:400).';
%          BestFit=fit_astrometric_binary(Orbit.JD,Orbit.X,Orbit.Y,[],[],Freq);
% Reliable: 2
%--------------------------------------------------------------------------
...
for Ifreq=1:1:Nfreq,
    %[Ifreq, Nfreq]
    P = 1./Freq(Ifreq);
    [Fit(Ifreq).X,Fit(Ifreq).Chi2]=fminsearch_my({@chi2_astrometric_binary, P, t, X, Y, ErrX, ErrY, FitPM, FitPlx, MeanRA, MeanDec, Coo},GuessPars);
end
...
[Chi2,Res] = chi2_astrometric_binary([El.e, El.T], El.P, t, X, Y, ErrX, ErrY,FitPM,FitPlx,MeanRA,MeanDec,Coo);
