...
% Example: t=[0:1:365].'; RV=binary_rv(t,365);
%          e=0.3; a=1; RV=binary_rv(t,365,0,a./(1-e),e,85./RAD,100);
% Reliable: 2
%--------------------------------------------------------------------------
