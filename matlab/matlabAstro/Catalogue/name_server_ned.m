function [RA,Dec]=name_server_ned(Name,OutUnits)
%--------------------------------------------------------------------------
% name_server_ned function                                       Catalogue
...
% Example: [RA,Dec]=name_server_ned('m31');
% Reliable: 2
%--------------------------------------------------------------------------
...
RA  = convertdms(Coo.RA,'SHh',OutUnits);
Dec = convertdms(Coo.Dec,'SDh',OutUnits);
