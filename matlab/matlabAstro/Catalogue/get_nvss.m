function Cat=get_nvss(RA,Dec,SearchRad)
%--------------------------------------------------------------------------
% get_nvss function                                              Catalogue
% Description: Search the NVSS (21 cm radio survey)
...
% Output : - Catalog of NVSS source within the search region.
...
% See also: get_first.m, get_cat.m
% Tested : Matlab R2014a
%     By : Eran O. Ofek                    Feb 2015
%    URL : http://weizmann.ac.il/home/eofek/matlab/
% Example: Cat=get_nvss(2,1);
%          Cat=get_nvss('12:00:00','+20:00:00');
% Reliable: 2
%--------------------------------------------------------------------------
InvRAD = pi./180;

HTMcenters    = 'NVSS_htm.mat';
%HTM_BASE_NAME = 'NVSS_htm%05d.mat';
DataDir       = 'NVSS_htm';
