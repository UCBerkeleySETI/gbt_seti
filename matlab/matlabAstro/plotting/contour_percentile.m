...
%--------------------------------------------------------------------------
% contour_percentile function                                     plotting
...
% Example: [Mat,C,H]=contour_percentile((1:1:10),(1:1:10),randi(100,10))
% Reliable: 2
%--------------------------------------------------------------------------
...
for Ilev=1:1:Nlev,
   ...
   PL(Ilev) = fun_binsearch(@summatlevel,Levels(Ilev),[0 1],1e-3,Mat);
end
