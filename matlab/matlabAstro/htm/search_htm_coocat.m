...
%            Use search_cat.m for large catalogs.
...
% Example: HTMind=search_htm_coocat(1,1,1./RAD,'APASS.mat')
%          HTMind=search_htm_coocat(1,1,1./RAD,'FIRST_htm.mat')
% Reliable: 2
%--------------------------------------------------------------------------
InvRAD    = pi./180;
...
if (Use_search_cat),
    ...
    D = sphere_dist_fast(HTMcenters.(CatField)(:,ColRA),HTMcenters.(CatField)(:,ColDec),...
                         RA,Dec);
    if (isempty(ColNsrc)),
