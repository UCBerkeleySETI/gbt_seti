...
% Example: [DirsList,DirsListURL,FilesList,FilesListURL]=rftpget('ftp://legacy.gsfc.nasa.gov/chandra/data/science/ao01/cat1/1/','rftp',1);
% Reliable: 2
%--------------------------------------------------------------------------
FTP_Listing = '.listing';
...
if (nargout>0),
   if (IsFTP),
      ListingFileCell = file2str(FTP_Listing,'cell');
