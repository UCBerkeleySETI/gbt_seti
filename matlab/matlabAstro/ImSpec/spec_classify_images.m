...
%                          (e.g., {@find_strcmpi,'FPA',DefV.ArmList}).
...
% spatial keyword
DefV.Key_ArmIndex      = {@find_strcmpi,'FPA',DefV.ArmList};
...
DefV.Key_Gain          = 'GAIN';
DefV.Key_RN            = 'RON';
DefV.Key_Dichroic      = {@spacedel, 'DICHROIC'};
DefV.Key_SlitWidth     = {@spacedel, 'APERTURE'};
DefV.Key_Turret        = {@spacedel, 'TURRET'};
DefV.Key_Lamps         = {@spacedel, 'LAMPS'};
