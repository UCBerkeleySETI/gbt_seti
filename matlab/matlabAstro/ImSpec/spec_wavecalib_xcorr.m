...
%-----------------------------------------------------
SpecInt     = subtract_back1d(SpecInt,InPar.Back,InPar.BackPar);
ArcTemplate = subtract_back1d(ArcTemplate,InPar.Back,InPar.BackPar);
...
if (Info.BestCorr<InPar.MinCorr),
    ...
    PolyFit = fitgenpoly(AllLines(:,1),AllLines(:,2),1,InPar.Deg,InPar.PolyFitPar{:});
