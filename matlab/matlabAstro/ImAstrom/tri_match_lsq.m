function [ParBest,Isel]=tri_match_lsq(ListRef,ListCat,varargin)
%--------------------------------------------------------------------------
% tri_match_lsq function                                          ImAstrom
...
% Example: [ParBest,Isel]=tri_match_lsq;   % run in simulation mode
%          [ParBest,Isel]=tri_match_lsq(ListRef,ListCat);
% Reliable: 2
%--------------------------------------------------------------------------
RAD           = 180./pi;
%ARCSEC_IN_DEG = 3600;
