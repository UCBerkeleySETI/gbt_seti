...
%          - Row vector of positions in which to perform the sinc
%            interpolation.
...
% Example: X=(1:1:100)'; Y=sin(2.*pi.*X./10); Yxx=interp1_sinc(Y,[2.1 3.4])
%          XX = [1:0.1:100]; Yxx=interp1_sinc(Y,XX)
% Reliable: 2
%--------------------------------------------------------------------------
