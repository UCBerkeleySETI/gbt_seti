...
%--------------------------------------------------------------------------
% read_ipac_table function                                         General
% Description: 
...
% Example: [Table]=read_ipac_table('tt');
% Reliable: 2
%--------------------------------------------------------------------------
...
switch lower(FileType)
    case 'str'
        CellLines = strlines2cell(File);
    case 'file'
        % do nothing
        CellLines = file2str(File,'cell');
    otherwise
...
%Table.Cat = read_formatted(File,Format,'comment',{'|','\'}); 
Table.Cat = read_str_formatted(CellLines,Format,'comment',{'|','\'});
