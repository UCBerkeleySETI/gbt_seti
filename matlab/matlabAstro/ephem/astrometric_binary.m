...
%--------------------------------------------------------------------------
% astrometric_binary function                                        ephem
...
% Example: [Orbit,Par]=astrometric_binary; plot(Orbit.X,Orbit.Y,'.');
% Reliable: 2
%--------------------------------------------------------------------------
...
ElS.q   = ElS.a.*(1 - ElS.e);
[Par.Nu,Par.R,Par.E]  = kepler_elliptic(M, ElS.q, ElS.e, NaN);
Par.dNudt = ElS.n.*sqrt(1-ElS.e.^2)./((1-ElS.e.*cos(Par.E)).^2);
%[Nu,R,dNudt]
[Orbit.X,Orbit.Y,Orbit.Z] = trueanom2pos(Par.R,Par.Nu,ElS.Omega,ElS.omega,ElS.i);
