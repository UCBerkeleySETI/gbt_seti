...
[SunRA0,SunDec0,SunR0,SolarLong0] = suncoo(JD,'j');
[SunRA1,SunDec1,SunR1,SolarLong1] = suncoo(JD+0.001,'j');
SunGalCoo0                    = coco([SunRA0,SunDec0],'j2000.0','g');
SunGalCoo1                    = coco([SunRA1,SunDec1],'j2000.0','g');
switch Type
 case 'G'
...
SunDist0                      = sphere_dist(SunGalCoo0(:,1),SunGalCoo0(:,2),GalCoo(:,1),GalCoo(:,2));
SunDist1                      = sphere_dist(SunGalCoo1(:,1),SunGalCoo1(:,2),GalCoo(:,1),GalCoo(:,2));
