...
RA1  = convertdms(RA1,'gH','r');
Dec1 = convertdms(Dec1,'gD','R');
RA2  = convertdms(RA2,'gH','r');
Dec2 = convertdms(Dec2,'gD','R');
...
[Dist,PA] = sphere_dist(RA1,Dec1,RA2,Dec2);
if (Dist==0),
   OffsetLong = 0;
   OffsetLat  = 0;
else
   ...
   switch lower(OffsetType)
    case 'rd'
       ...
       CD1  = cosined([RA1,Dec1]);
       CD12 = cosined([RA2,Dec1]);
       CD2  = cosined([RA2,Dec2]);
