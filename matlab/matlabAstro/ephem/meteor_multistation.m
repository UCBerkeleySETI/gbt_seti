...
%------------------------------------------------------------------------------
% meteor_multistation function                                           ephem
...
% Example: [Az,Alt,Dist,Coo]=meteor_multistation([34.763 30.596; 35 31]./(180./pi),100000,[1 1]);
% Reliable: 2
%------------------------------------------------------------------------------
DATUM = 'WGS84';
...
[MetGeocCoo,Vm] = geod2geoc([MetLong, MetLat, H], DATUM);
...
for I=2:1:CooSize(1),
   ...
   [GeocCoo,V2] = geod2geoc(CooList(I,:), DATUM);
   ...
   [D,PA]  = sphere_dist(PLong, PLat, MetLong, MetLat);
   Az(I)   = PA;
end
