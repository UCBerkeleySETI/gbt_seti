...
%            returns the X, Y, Z position vectors.
% Tested : Matlab 5.3
%     By : Eran O. Ofek                    Aug 2001
%    URL : http://weizmann.ac.il/home/eofek/matlab/
% See also: trueanom2vel.m
% Example: [X,Y,Z] = trueanom2pos(1,[0;1],1,1,1);
%          [XYZ] = trueanom2pos(1,[0;1],1,1,1);
%          [XYZ] = trueanom2pos([1;2],[0;1],1,1,1);
%          [XYZ] = trueanom2pos([1;2],[0;1],1,1,[1;0.1]);
% Reliable: 1
%------------------------------------------------------------------------------
