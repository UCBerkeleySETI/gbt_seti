...
Rate1 = sphere_dist(List1(1:end-1,Col1(1)), List1(1:end-1,Col1(2)), List1(2:end,Col1(1)), List1(2:end,Col1(2))); 
Rate2 = sphere_dist(List2(1:end-1,Col2(1)), List2(1:end-1,Col2(2)), List2(2:end,Col2(1)), List2(2:end,Col2(2))); 
...
[Dist,PA] = sphere_dist(List1(:,Col1(1)),List1(:,Col1(2)),List2(:,Col2(1)),List2(:,Col2(2)));
   ...
   if (isempty(Extram)==1),
      ...
      for Im=1:1:Nm,
         ...
         if (FlagConvSmallWin(MinInd)>0.5),
            ...
            [D,PA] = sphere_dist(InterpList1(Col1(1)),InterpList1(Col1(2)), InterpList2(Col2(1)),InterpList2(Col2(2)));
