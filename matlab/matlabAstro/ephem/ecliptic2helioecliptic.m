...
%--------------------------------------------------------------------------
% ecliptic2helioecliptic function                                    ephem
...
%            additional options.
%          - Date [Day Mounth Year FracDay]. See julday.m for options.
...
% Example: HelioEcLong=ecliptic2helioecliptic(1,[21 3 2000])
% Reliable: 2
%--------------------------------------------------------------------------
...
HelioEcLong = Long - SL;
HelioEcLong=angle_in2pi(HelioEcLong);
