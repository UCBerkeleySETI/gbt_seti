...
% Example: DeltaT=delta_t([2451545;julday])
% Reliable: 2
%--------------------------------------------------------------------------


Ranges = [-390 948 1620 1800 1900 1961].';
YearJD = year2jd(Ranges);
...
Theta = (JD(Flag)-julday([1 1 1800]))./36525;
...
Theta = (JD(Flag)-julday([1 1 1700]))./36525;
...
Theta = (JD(Flag)-julday([1 1 1900]))./36525;
...
% exact
Flag = JD>YearJD(6);
TAImUTC = tai_utc(JD(Flag));
UT1mUTC = ut1_utc(JD(Flag));
