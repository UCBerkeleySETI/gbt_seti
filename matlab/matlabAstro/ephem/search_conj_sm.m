...
for Istat=1:1:Nstat,
    ...
    % in moving object
   [Dist,PA] = sphere_dist(List1(:,Col1(1)),List1(:,Col1(2)),List2(Istat,Col2(1)),List2(Istat,Col2(2)));
      ...
      if(isempty(Extram)==1),
         ...
         for Im=1:1:Nm,
            ...
            if (FlagConvSmallWin(MinInd)>0.5),
               ...
               [D,PA] = sphere_dist(InterpList1(Col1(1)),InterpList1(Col1(2)), List2(Istat,Col2(1)),List2(Istat,Col2(2)));
