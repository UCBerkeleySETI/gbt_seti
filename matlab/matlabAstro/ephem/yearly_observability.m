...
%------------------------------------------------------------------------------
% yearly_observability function                                          ephem
...
% See also: daily_observability.m, obspl.m
% Example: yearly_observability(2001,[10 0 0 -1 20 0 0],'Wise',2,2.5);
% Bug    : yearly_observability(2001,[10 0 0 +1 20 0 0],'SAO',0,2.5);
% Reliable: 2
%------------------------------------------------------------------------------
RAD = 180./pi;
...
if (ColN==2),
   % already in radians
elseif (ColN==7),
   RA  = convertdms(ObjCoo(:,1:3),'H','r');
   Dec = convertdms(ObjCoo(:,4:7),'D','R');
   ObjCoo = [RA, Dec];
else
