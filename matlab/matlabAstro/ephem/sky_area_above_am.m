...
%--------------------------------------------------------------------------
% sky_area_above_am function                                         ephem
% Description: Calculate sky area observable during the night above a
...
% Example: for I=1:1:366, [SkyArea16(I),LON(I)]=isvisible_nightsky(VecJD(I),Lat,AM,TimeVis); end
% Reliable: 2
%--------------------------------------------------------------------------
...
JD = floor(JD)+0.5;
[Time,Ang]=sun_rise_set(JD,[0 Lat],0,0);
UTend    = Time(2);
UTstart  = Time(8);
