...
%--------------------------------------------------------------------------
% spec_photon_counts function                                    AstroSpec
...
% Example: [Flux,Counts]=spec_photon_counts(5770,[100 300000],[],696000e5,10);
...
% Count rate:
EnConv  = convert_energy(ObsSpec(:,1),'A','erg');     % conversion between erg to Ang.
