...
%------------------------------------------------------------------------------
% black_body function                                                AstroSpec
% Description: Calculate a black-body spectrum given its temperature.
% Input  : - Temperature [K].
...
% Example:  [Il,In,IlA,ImJy,Ip]=black_body(10000,logspace(1,4,100).');
% Reliable: 1
%------------------------------------------------------------------------------
Def.Type = 'P';
if (nargin==2),
