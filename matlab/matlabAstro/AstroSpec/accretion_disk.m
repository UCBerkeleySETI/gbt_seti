...
%------------------------------------------------------------------------------
% accretion_disk function                                            AstroSpec
...
% Example: [Spec,VecR,VecT,Rs]=accretion_disk(1e6,0.1,10,100);
% Reliable: 2
%-------------------------------------------------------------------------
Rin_Def    = 10;
Rout_Def   = 1000;
...
%--- Constants ---
Msun     = get_constant('SolM','cgs');      % solar mass [gram]
SecYear  = 365.25.*86400; %get_constant('JY','cgs');        % sec in year
G        = get_constant('G','cgs');         % gravitational constant [cgs]
Sig      = get_constant('sigma','cgs');     % Stefan-Boltzmann constant [cgs]
c        = get_constant('c','cgs');         % speed of light [cm]
