...
switch lower(InPar.IsListFF)
    ...
    case 'n'
        ...
        FlagDomeFF = (isempty_cell(strfind(cellfun(@num2str,{KeywordS.NAME},'UniformOutput',false),InPar.HeadKeysVal{2}))==0) & ...
                     (isempty_cell(strfind(cellfun(@num2str,{KeywordS.OBJECT},'UniformOutput',false),InPar.HeadKeysVal{1}))==0) & ...
