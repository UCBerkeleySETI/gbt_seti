...
switch Geom
 case 'sphere'
    DistIJ  = sphere_dist(RA(1),Dec(1),RA(2:end),Dec(2:end));
 case 'plane'
    DistIJ  = plane_dist(RA(1),Dec(1),RA(2:end),Dec(2:end));
 otherwise
...
switch Geom
 case 'sphere'
    [Dist,PA] = sphere_dist(RA,Dec,BestCen(1),BestCen(2)); 
 case 'plane'
    [Dist,PA] = plane_dist(RA,Dec,BestCen(1),BestCen(2)); 
 otherwise
    error('Unknown geometry option');
end
