...
%--------------------------------------------------------------------------
% microlens_pspar function                                    microlensing
...
%          [Mag,Res]=microlens_pspar([2451545 0.001 4.71 -0.35 0.0001 0.0001 0.0001 0.0001 0.0001 1 18],JD); 
%          [Mag1,Res1]=microlens_pspar([2451545 0.001 4.71 -0.35 0.0001 0.0001 0.0001 0.0001 0.000001 1 18],JD); 
%          plot(JD,Mag); hold on; plot(JD,Mag1,'r-'); invy
% Reliable: 2
%--------------------------------------------------------------------------
...
[Mag,Res]=microlens_psb([Alpha, BaseMag],BetaT);
