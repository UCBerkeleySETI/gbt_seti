...
%            'CompareArcKeyVal' - How to compare the keyword value with the
%                        keyword values map:
...
DefV.CompareArcKeyVal = 'strcmpi';  % {'strcmpi'|'bit'}
% check images
...
for Iim=1:1:Nim,
    ...
    % truncate spaces
    Val = spacedel(Val);
    switch lower(InPar.CompareArcKeyVal)
        case 'strcmpi'
        ...
        otherwise
            error('Unknown CompareArcKeyVal option');
    end
